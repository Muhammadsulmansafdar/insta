...
class PostItem extends StatelessWidget {
  ...
  final String dayAgo;
  const PostItem({
    required this.profileImg, required this.name, required this.postImg, this.isLoved, required this.likedBy, required this.viewCount, required this.dayAgo, required this.caption,
  });
